...
export function CustomerForm({ clientName }: CustomerFormProps) {
  const handlePrint = () => {
    window.print();
  };
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-6 print:shadow-none">
        ...
        <div className="mb-8">
          <p className="text-slate-700">
            Dette dokumentet gir deg en oversikt over informasjon og tilganger vi trenger for å sette opp annonsering, Klaviyo, sporing og løpende drift for {clientName}.
          </p>
        ...
        {/* Section 3 */}
        <section className="mb-8 pb-8 border-b border-slate-200">
          <h2 className="text-slate-900 mb-4">3. Tilganger – Kritisk for oppstart</h2>
          ...
          <div className="space-y-6">
            <div className="bg-slate-50 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li className="text-slate-600 text-sm ml-7">
                  Trengs for Klaviyo-integrasjon, pixel-sjekk, sporing og Google Merchant Center
                </li>
              </ul>
            </div>
            ...
            <div className="bg-slate-50 rounded-lg p-4">
              <h3 className="text-slate-900 mb-3">Klaviyo</h3>
              <ul className="space-y-2 text-slate-700">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
                  <span>Administrator-tilgang (hvis konto finnes)</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
                  <span>E-post for kontoopprettelse (hvis ny konto)</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
                  <span>DNS-tilgang for domeneverifisering</span>
                </li>
              </ul>
            </div>
        ...
        {/* Section 4 */}
        <section className="mb-8 pb-8 border-b border-slate-200">
          <h2 className="text-slate-900 mb-4">4. Kreative Ressurser</h2>
          <p className="text-slate-600 mb-4">
        ...
        {/* Section 5 */}
        <section className="mb-8 pb-8 border-b border-slate-200">
          <h2 className="text-slate-900 mb-4">5. Annonseringsbudsjett</h2>
          <div className="space-y-3 text-slate-700">
            <div className="flex items-start gap-2">
              <CheckCircle className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
              <div>
